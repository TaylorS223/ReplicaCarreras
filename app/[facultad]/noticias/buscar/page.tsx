...
export default async function BuscarNoticiasPage({
  params,
  searchParams,
}: BuscarNoticiasPageProps) {
    ...
    <div className="ap-wrapper">
      <div className="ap-page-title">
        <div className="container">
          ...
          <h3 className="ap-page-heading">Search Results</h3>
        </div>
      </div>
      ...
      <div className="container ap-body">
        ...
        <aside className="ap-sidebar">
          <NoticiasSearchForm facultad={facultad} initialQuery={q ?? ""} />
